	...
	public void fakerInsetEmpDetails( Principal principal) {
	 ...
	 Date fakerDate = faker.date().birthday();
	  ...
	  getMasterEmployeeDetails.setLastName(lastName);
	    ...
	    getMasterEmployeeDetails.setDesignations(this.designationsRepository.findById(7).get());
	    ...
	    getMasterEmployeeDetails.setEmployeeType(this.employeeTypeRepo.findById(1).get());
	    ...
	    getMasterEmployeeDetails.setSubDepartments(this.subDepartmentsRepositorye.findById(3).get());
	    getMasterEmployeeDetails.setSupervisor(this.masterEmployeeDetailsRepository.findById(faker.number().numberBetween(1222, 1522)).get());
